 ...
 */
export async function getElementDeploymentAddresses(url: string): Promise<DeploymentAddresses> {
  const params = {
  ...
  return new Promise(function (resolve, reject) {
    const req = https.request(params, function (res) {
      ...
      res.on("end", function () {
        try {
          result = <DeploymentAddresses>JSON.parse(Buffer.concat(body).toString());
        } catch (e) {
          reject(e);
        }
        resolve(result);
 ...
 */
export function getElementTermFactoryAddresses(deploymentAddresses: DeploymentAddresses): string[] {
 ...
 */
export function getElementTermAddresses(deploymentAddresses: DeploymentAddresses): string[] {
  // get each Term
  const terms = [];
  for (const trancheListKey in deploymentAddresses.tranches) {
    const trancheList = (deploymentAddresses.tranches as any)[trancheListKey];
 ...
 */
export function getElementPtPoolAddresses(deploymentAddresses: DeploymentAddresses): string[] {
 ...
 */
export function getElementYtPoolAddresses(deploymentAddresses: DeploymentAddresses): string[] {
